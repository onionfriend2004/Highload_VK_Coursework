...
- **Participants Message Handler** читает Kafka, получает участников из **Participants Service**, и отправляет сообщение каждому через его WSH.

**Participants Service** хранит данные о группах в **Postgres** и кэширует в **Aerospike**.
