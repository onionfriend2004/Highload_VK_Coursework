...
$$0.0018 \cdot 2 \cdot 10^7 =  36000 \space Гбит/с = 36 \space Тбит/с$$ 
...
$$10^{-4} \cdot 2 \cdot 10^7  = 2000 \space Гбит/с$$ 

* Сохранение записи в облаке для всех пользователей

$$1.2 \cdot 10^{-3} \cdot 2 \cdot 10^7 =  24000 \space Гбит/с = 24 \space Тбит/с$$ 

| Тип трафика                          | Базовый     | Пиковый        | Суммарно в сутки  |
|--------------------------------------|----------------------|-------------------------|-----------------------------|
| Пропускная способность видео для всех пользователей |36 Тбит/с| 108 Тбит/с| 494.4 ПБ/сутки|
| Передача аудио для всех пользователей            |2000 Гбит/с| 6000 Гбит/с| 28 125 ТБ/сутки|
| Сохранение записи в облаке            |24 Тбит/с|72 Тбит/с| 329.6 ПБ/сутки|
